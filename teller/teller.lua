...
function sendPassToUser(nickname, password)
  ...
  runCommand("tell "..nickname.." Вас приветствует [Totoro Bank]. Ваш личный пароль: "..password)
  runCommand("tell "..nickname.." Внимание! Никогда и никому не передавайте свой пароль!")
end
...
function getPairID(filename)
  ...
  file:write("ID = 1\nCB = 4b9e6a20-a25c-4ae2-9a7c-d4afcadbb9fb")
  file:close()
  ID = 1
  VIRTUALCB = '4b9e6a20-a25c-4ae2-9a7c-d4afcadbb9fb'
  return false
end
